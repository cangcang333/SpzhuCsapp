 ...
 * min(n, rio_cnt) bytes from an internal buffer to a user buffer, where n 
 * is the number of bytes requested by the user and rio_cnt is the number
 * of unread bytes in the internal buffer. On entry, rio_read() refills the
